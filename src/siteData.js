  ...
  am: {
    ...
    pages: {
      ...
      "/about": {
        ...
        tableBody: [
          {
            labels: "የመስክ ልምድ", values: "ከ2 ዓመት በላይ ቀጥተኛ የአካባቢ የወርቅ ማቀነባበሪያ ልምድ",  bgImage:img1,
          },
          {
            labels: "የክልል ተደራሽነት", values: "በኩምሩክ፣ ሸርኮሌ እና መንጌ ኮሪደሮች ውስጥ ንቁ ስራዎችና ማጣቀሻዎች",  bgImage:img2,
          },
          {
            labels: "የማቴሪያል እውቀት", values: "በኳርትዝ ማቴሪያል፣ ቅሪቶች እና ቴይሊንግስ ላይ የተረጋገጡ የማገገሚያ ውጤቶች",  bgImage:img3,
          }
        ],
